...
public class CorsConfig implements WebMvcConfigurer {
    ...
    public void addCorsMappings(CorsRegistry registry) {
        registry.addMapping("/**")
                /**
                 * .allowCredentials() 当true时 改为.allowedOriginPatterns("*")
                 */
                 ...
                 * false — cookies不应该包括在内； "" — 意味着未定义，允许所有值； true —
                 * 预响应将包括值设置为true的报头Access-Control-Allow-Credentials
                 */
